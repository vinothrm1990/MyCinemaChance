...
public class DirectorPlayerPreviewActivity extends YouTubeBaseActivity implements Connection.Receiver {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_director_player_preview);
    ...
    private void playerConnected(boolean isConnected) {
        ...
        if (!isConnected){
            ...
            Alerter.create(DirectorPlayerPreviewActivity.this)
